...
from typing import Any, Mapping, Optional, Sequence, Tuple, Self, Generic, TypeVar
...
class AbstractModel(Generic[IdType], ABC):
    ...
    @classmethod
    @abstractmethod
    async def update_by_id(cls, id_value: IdType, data: Mapping[str, Any], **kwargs) -> bool:
        ...
